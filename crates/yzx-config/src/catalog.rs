...
pub(crate) const KEY_BINDINGS: &[[&str; 5]] = &[
    ...
    key!("Panes"; "Alt j / Alt Down"; "Move focus down circularly"; "Yazelix"; "config.kdl"),
    key!("Panes"; "Alt k / Alt Up"; "Move focus up circularly"; "Yazelix"; "config.kdl"),
    ...
    key!("Panes"; "Ctrl Alt j"; "Move pane down circularly"; "Yazelix"; "config.kdl"),
    key!("Panes"; "Ctrl Alt k"; "Move pane up circularly"; "Yazelix"; "config.kdl"),
    ...
    key!("File manager"; "Shift z"; "Jump with zoxide without changing the tab workspace"; "Yazi"; "Yazi default"),
    key!("File manager"; "Alt Enter"; "Use current folder as tab workspace"; "Yazi"; "yazi/keymap.toml"),
];
